...
else if($column != "")
{
    ...
    //  echo '<div class="client_name" style="text-transform:capitalize;position:absolute;top:137px;">'.$campaign.'</div><br>';
...
<body>
    <div class="chrt" >
      ...
      <label><strong> Select Cohort - </strong> </label>
        ...
        <?php $url = "support.php?client=".$client;?>
...
<script>
 ...
 function recom(){
     ctr.forEach(ctr => {
        ...
        dyn.forEach((dyn,i) => {
        //  dis is less then 10 and overall ctr se greater(toh dis incre client)
            if(Number(dist[i]) <= 10 && Number(ctr[i]) >= Number(mainctr)){
                ...
                e3.innerHTML = "<span style='font-size:15px'> ID is very low on <span style='color:#24b2be;font-family: 'RobotoB';> " +dyn+ "</span> but CTR is <span style='color:#24b2be;font-family: 'RobotoB';>  "+percent+"% </span> high as compared to Avg CTR. <br> HC Recommends : Increase the ID on <span style='color:#24b2be;font-family: 'RobotoB';> " +dyn+ "</span>.</span>";
              
              document.getElementById("swiper-slide"+i).appendChild(e3);
            }
            
            // dis greater then 15 and ctr is greather them mainctr
            ...
            //  dis isin between 10-15 and overall ctr se greater(toh dis incre client)
                ...
                e3.innerHTML = "<span style='font-size:15px'> ID is Avg on<span style='color:#24b2be;font-family: 'RobotoB;'> " +dyn+ "</span> and CTR is <span style='color:#24b2be;font-family: 'RobotoB';>  "+percent+"% </span> high as compared to Avg CTR.<br> HC Recommends : Increase the ID on<span style='color:#24b2be;font-family: 'RobotoB';>  " +dyn+ "</span>.</span>";
              
              document.getElementById("swiper-slide"+i).appendChild(e3);
            }
            
                   //  dis is greater then 15 and overall ctr se lower (toh dis dec client)
            else if(Number(dist[i]) >= 15 && Number(ctr[i]) <= Number(mainctr)){
                ...
                e3.className = "swip_card";
                e3.style="padding-top:-20px";
                e3.innerHTML = "<span style='font-size:15px'> ID is high on <span style='color:red;font-family: 'RobotoB;'> " +dyn+ "</span> and CTR is <span style='color:red;font-family: 'RobotoB';>  "+percent+"% </span> lower as compared to Avg CTR.<br> HC Recommends : Decrease the ID on <span style='color:red;font-family: 'RobotoB';>  " +dyn+ "</span>.</span>";
              
              document.getElementById("swiper-slide"+i).appendChild(e3);
            }
            
            // dis is greather then 15 and ctr is greather than avg ctr
              else if(Number(dist[i]) >= 15 && Number(ctr[i]) > Number(mainctr)){
            ...
            // dis lessthen10
                ...
                e3.className = "swip_card";
                e3.style="padding-top:-20px";
                e3.innerHTML = "<span style='font-size:15px'> ID is very low on <span style='color:red;font-family: 'RobotoB;'> " +dyn+ "</span> and CTR is <span style='color:red;font-family: 'RobotoB';>  "+percent+"% </span> low as compared to Avg CTR.<br> HC Recommends : Decrease the ID on  <span style='color:red;font-family: 'RobotoB';>  " +dyn+ "</span>.</span>";
