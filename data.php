...
<body>
    <div class="chrt" >
      ...
      <label><strong> Select Cohort - </strong> </label>
        <select name="fcol" id="fcol" style="border:2px solid #24b2be" class="fcol">
     ...
     ctr.forEach(ctr => {
        ...
        //  dis is less then 10 and overall ctr se greater(toh dis incre client)
            if(Number(dist[i]) <= 10 && Number(ctr[i]) >= Number(mainctr)){
                ...
                e3.innerHTML = "<span style='font-size:15px'> ID is very low on " +dyn+ " but CTR is "+percent+"% high as compared to Average CTR, Hc Recommends you to increase the ID on " +dyn+ ".</span>";
              
              document.getElementById("swiper-slide"+i).appendChild(e3);
            }
            else if(Number(dist[i]) == 100 && Number(ctr[i]) == Number(mainctr)){
                ...
                e3.className = "swip_card";
                e3.style="padding-top:-20px";
                e3.innerHTML = "<span style='font-size:15px'> ID is high and CTR is equal as compared to Average CTR, HC Recommends you to check the rest of the cohorts.</span>";
            ...
            //  dis isin between 10-15 and overall ctr se greater(toh dis incre client)
                ...
                e3.innerHTML = "<span style='font-size:15px'> ID is average on " +dyn+ " but CTR is "+percent+"% high as compared to Average CTR, HC Recommends you to increase the ID on " +dyn+ ".</span>";
              ...
              document.getElementById("swiper-slide"+i).appendChild(e3);
                ...
                e3.className = "swip_card";
                e3.style="padding-top:-20px";
                e3.innerHTML = "<span style='font-size:15px'> ID is high on " +dyn+ " but CTR is "+percent+"% lower as compared to Average CTR, HC Recommends you to decrease the ID on " +dyn+ ".</span>";
...
var dyn1 = <?php echo json_encode($dyn) ?>;
if(dyn1 != "0")
{
